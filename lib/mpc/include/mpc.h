 ...
 */
void doControlStep(std::vector<std::vector<double>> &u_opt, casadi::MX &pos_ref,
                   casadi::MX &obj_pos, casadi::MX &vel_ref, casadi::DM &pos_0,
                   casadi::DM &vel_0, casadi::DM &alpha_0, casadi::DM &beta_0,
                   double time, double dt, int debug_level,
