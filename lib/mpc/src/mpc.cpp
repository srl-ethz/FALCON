...
void AttitudeMPC::doControlStep(std::vector<std::vector<double>> &u_opt,
                                casadi::MX &pos_ref, casadi::MX &obj_pos,
                                casadi::MX &vel_ref, casadi::DM &pos_0,
                                casadi::DM &vel_0, casadi::DM &alpha_0,
                                casadi::DM &beta_0, double time, double dt,
                                int debug_level, std::string file_name) {
  /////////////////////////////////////////////////////////////////// parameters
  // input constraints
  ...
  file.open(path);
  file << "i,u0_opt,u1_opt,u2_opt,x,z,v_abs,v_arg,vx,vz,gripx,gripz,aoa,aoa_"
          "true\n";
  ...
  for (int i = 0; i < horizon; i++) {
    ...
    file << aoa_vec.at(0) << ","
         << sol_vec.at(1) - std::atan2(vel_cart_vec.at(1), vel_cart_vec.at(0))
         << "\n";
  }
  file.close();
