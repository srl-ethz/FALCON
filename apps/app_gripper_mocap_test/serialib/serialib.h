...
over a serial device. \author  Philippe Lucidarme (University of Angers)
\version 2.0
...
SOFTWARE OR THE USE OR OTHER DEALINGS IN THE SOFTWARE. This is a licence-free
software, it can be used by anyone who try to build a better world.
*/
